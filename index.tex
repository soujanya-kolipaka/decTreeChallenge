...
\item
  ...
  find. answer: \textbf{🌳 Decision Trees, Feature Importance, and the
  Encoding Story} Decision trees are often celebrated for their
  interpretability. They provide a clear ranking of which variables
  drive predictions, making them attractive for business users who want
  transparency. But when I explored how feature importance is
  calculated, I discovered a subtle trap: the way categorical variables
  are encoded can dramatically distort the story the tree tells.
\end{enumerate}
